...
const nutils = require('@abeai/node-utils');
...
class HasMany extends Association {
  ...
  injectAttributes() {
    const newAttributes = {};
    const constraintOptions = nutils.clone(this.options); // Create a new options object for use with addForeignKeyConstraints, to avoid polluting this.options in case it is later used for a n:m
